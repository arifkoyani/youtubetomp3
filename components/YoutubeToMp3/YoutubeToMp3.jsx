      ...
      <div className="w-full max-w-2xl text-center">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full max-w-[300px] shadow-4xl bg-[#e68e00] hover:bg-[#f8a217eb] text-black font-medium py-3 px-6 rounded-lg transition-colors cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
          >
